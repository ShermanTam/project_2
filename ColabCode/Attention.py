# -*- coding: utf-8 -*-
"""Imagecaption_Attention_With Audio.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1Sn98FeAn4TUnpeptXGUEyACw4Fvc6HFr
"""

# load the file containing all of the captions into a single long string
#caption_file = "/Users/bhaktiraichura/Downloads/Flickr8k_text/Flickr8k.token.txt" 
...
# load the file containing all of the captions into a single long string
caption_file = "/content/drive/MyDrive/Flickr8/Flickr8k_text/Flickr8k.token.txt" 
def load_captions (filename):
  with open(filename, "r") as fp:
    # Read all text in the file
    text = fp.read()
...
def subset_image_name (filename):
  ...
  with open(filename, "r") as fp:
    ...
    return (set(data))  
training_image_name_file = "/content/drive/MyDrive/Flickr8/Flickr8k_text/Flickr_8k.trainImages.txt"
...
# Create a GPU device to run the code on
device = tf.device('/device:GPU:0')

# Use the device context to execute the code on the GPU
with device:
